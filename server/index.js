...
app.use(cors({
    origin: ['https://book-collection-web-project.vercel.app'],
    ...
    bcrypt.hash(password, saltRounds, (err, hash) => {
        ...
        db.query(
            ...
            (err, result) => {
                ...
                if (result && result.length > 0){         //if username in database...
...
app.get('/checkRead/:userId/:bookId', async (req, res) => {
...
app.get('/currRead/:userId', async (req, res) => {
    const {userId} = req.params;
...
app.get('/checkCurrRead/:userId/:bookId', async (req, res) => {
    const {userId, bookId} = req.params;
    try {
...
app.delete('/droppedBooks', (req, res) => {
    const {userId, book} = req.body;
...
app.get('/droppedBooks/:userId', async (req, res) => {
    const {userId} = req.params;
...
app.get('/checkDroppedBooks/:userId/:bookId', async (req, res) => {
    const {userId, bookId} = req.params;
    try {
...
app.post('/wishlistBooks', (req, res) => {
    const {userId, book} = req.body;
...
app.delete('/wishlistBooks', (req, res) => {
    const {userId, book} = req.body;
...
//Getting all books from DroppedBooks List
app.get('/wishlistBooks/:userId', async (req, res) => {
    const {userId} = req.params;
...
app.get('/checkWishlistBooks/:userId/:bookId', async (req, res) => {
    const {userId, bookId} = req.params;
    try {
